...
const EASE = {
  ...
  // Values per the design system (tokens/motion.css) — the canonical source
  // for this project from here on.
...
.field[data-invalid='true'] .control{border-bottom-color:var(--danger)}
...
.successCard--failed{border-color:var(--danger)}
